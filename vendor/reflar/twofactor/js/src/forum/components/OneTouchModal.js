    ...
    content() {
        ...
        return (
            <div className='Modal-body'>
                <h2 className="TwoFactor-title">{app.translator.trans('reflar-twofactor.forum.modal.oneTouchHeader')}</h2>
                <div id='spinner'>
                    {LoadingIndicator.component({style: 'transform: scale(1.5);'})}
                </div>
                {this.code() ? [
                    <input type='text'
                           id="code"
                    ...
                    <Button className='Button Button--primary TwoFactor-inputButton' loading={this.loading} type='submit'>
